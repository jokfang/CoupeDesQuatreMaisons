...
import { cupActive, bareme, numberBits, bareme_multiple } from "../librairy/cupInfo.js";
...
export function getButtonInterface(message) {
  ...
  message.channel.send({ content: "***Menu des Interfaces***", components: [rowButton] });
}
...
export async function getButtonInterface_PointByHouse(interaction) {
  ...
  const rowHouse0 = new Discord.ActionRowBuilder()
    .addComponents(
      new Discord.ButtonBuilder()
  ...
  const rowHouse1 = new Discord.ActionRowBuilder()
    .addComponents(
      new Discord.ButtonBuilder()
  ...
  const rowHouse2 = new Discord.ActionRowBuilder()
    .addComponents(
      new Discord.ButtonBuilder()
  ...
  const rowHouse3 = new Discord.ActionRowBuilder()
    .addComponents(
      new Discord.ButtonBuilder()
  ...
  interaction.reply({ content: "***Menu: Ajoute de point par maison***", components: [rowHouse0, rowHouse1, rowHouse2, rowHouse3], ephemeral: true });
...
export async function getButtonInterface_house(interaction, house) {
  ...
  let rowBits = new Discord.ActionRowBuilder()
    .addComponents(new Discord.ButtonBuilder()
      .setCustomId("add_" + house + "_bits")
      .setLabel("100 Bits")
      .setStyle(ButtonStyle.Secondary)
    );
  let rowSubT1 = new Discord.ActionRowBuilder().addComponents(new Discord.ButtonBuilder()
    .setCustomId("add_" + house + "_subT1")
    .setLabel("SubT1")
    .setStyle(ButtonStyle.Secondary)
  );;
  let rowSubT2 = new Discord.ActionRowBuilder().addComponents(new Discord.ButtonBuilder()
    .setCustomId("add_" + house + "_subT2")
    .setLabel("SubT2")
    .setStyle(ButtonStyle.Secondary)
  );;
  let rowSubT3 = new Discord.ActionRowBuilder().addComponents(new Discord.ButtonBuilder()
  ...
  for (let propriety in bareme_multiple) {
    ...
    switch (type) {
      case 'bits':
        rowBits.addComponents(new Discord.ButtonBuilder()
        ...
        break;
      case 'subT1':
        rowSubT1.addComponents(new Discord.ButtonBuilder()
          .setCustomId("addMultiple_" + house + "_" + propriety)
          .setLabel(multipleType + " " + type)
          .setStyle(ButtonStyle.Primary)
        );
        break;
      case 'subT2':
        rowSubT2.addComponents(new Discord.ButtonBuilder()
          .setCustomId("addMultiple_" + house + "_" + propriety)
          .setLabel(multipleType + " " + type)
          .setStyle(ButtonStyle.Primary)
        );
        break;
      case 'subT3':
        rowSubT3.addComponents(new Discord.ButtonBuilder()
          .setCustomId("addMultiple_" + house + "_" + propriety)
          .setLabel(multipleType + " " + type)
          .setStyle(ButtonStyle.Primary)
        );
  ...
  interaction.reply({ content: "***" + house + "***", components: [rowBits, rowSubT1, rowSubT2, rowSubT3], ephemeral: true });
};
...
function getButtonHouse(maisons, i, rowHouse) {
  for (let type in bareme) {
    ...
    if (type == "bits") {
      messageLabel = messageLabel.replace(type, numberBits + " " +type)
    }

    rowHouse.addComponents(new Discord.ButtonBuilder()
